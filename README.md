...
| ---------- | ----------- | 
| view_item_list  | To measure how often item details are viewed, send a view_item_list event whenever a user views an item’s list after a search. |
...
# Screenshot - view_item_list - tag should be executed after the user completes the search action in service with parameters in the datalayer:
